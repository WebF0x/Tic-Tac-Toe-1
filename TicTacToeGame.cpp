...
// do magic here (minimax algorithm)
...
// this is a bit crude, I should probably refactor this to two loops sometime
...
// prints the board, seems to have a bug because i have to call this method once before printing it
